  ...
  if (!current) {
    return (
      <main className="flex min-h-screen flex-col items-center justify-center bg-[#fbf8f3] px-4 py-20 text-center">
        ...
        <Link
          href="/"
          className="mt-8 inline-flex items-center gap-2 rounded-2xl border border-[#d8c4b2] bg-white px-6 py-3 text-sm font-medium text-foreground shadow-sm hover:bg-[#f7f1eb]"
        >
          홈으로 이동
        </Link>
      </main>
          ...
          <div className="grid gap-3 lg:h-[760px] lg:grid-rows-[minmax(360px,0.9fr)_minmax(0,1.1fr)]">
            ...
            <section className="flex min-h-0 flex-col border border-[#722f37]/18 bg-white p-5">
              <div className="flex items-start justify-between gap-3 border-b border-[#722f37]/10 pb-4">
                ...
                {infoConcert ? (
                  <div className="inline-flex shrink-0 items-center gap-2 border border-[#722f37]/16 bg-[#f8f1f2] px-3 py-1.5 text-xs font-semibold text-[#722f37]">
