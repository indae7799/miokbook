...
exports.bulkCreateBooks = void 0;
/**
...
exports.bulkCreateBooks = (0, https_1.onCall)({ enforceAppCheck: false }, async (request) => {
    ...
    if (!ttbKey)
        throw new https_1.HttpsError('failed-precondition', 'INTERNAL_ERROR');
...
async function getDefaultCoverUrl(bucket) {
