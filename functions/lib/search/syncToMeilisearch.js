...
exports.syncToMeilisearch = void 0;
/**
...
const aladinCategorySlug_1 = require("../lib/aladinCategorySlug");
...
function getClient() {
    ...
    if (!host || !apiKey)
        return null;
    return new meilisearch_1.MeiliSearch({ host, apiKey });
}
/** 공백 완전 제거. "교과서 소설 다보기3" → "교과서소설다보기3" */
function normalizeTitle(title) {
    return title.replace(/\s+/g, '');
}
exports.syncToMeilisearch = (0, firestore_1.onDocumentWritten)('books/{isbn}', async (event) => {
    ...
    try {
        ...
        const doc = {
            ...
            category: (0, aladinCategorySlug_1.mapAladinCategoryToSlug)(String(d?.category ?? '')),
